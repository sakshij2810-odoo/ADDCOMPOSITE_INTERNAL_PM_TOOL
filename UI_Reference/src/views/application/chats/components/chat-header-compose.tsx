  ...
  return (
    <>
      ...
      <Autocomplete
        ...
        options={contacts}
        getOptionLabel={(recipient) => recipient.user_name}
        ...
        renderOption={(props, recipient, { selected }) => (
          <li {...props} key={recipient.user_uuid}>
            <Box
              key={recipient.user_uuid}
              sx={{
                mr: 1,
                width: 32,
                height: 32,
            ...
            >
              <Avatar alt={recipient.user_name} src={recipient.avatar_url} sx={{ width: 1, height: 1 }} />
              <Stack
                alignItems="center"
        ...
        renderTags={(selected, getTagProps) =>
          selected.map((recipient, index) => (
            <Chip
              ...
              avatar={<Avatar alt={recipient.user_name} src={recipient.avatar_url} />}
              size="small"
              variant="soft"
            />
          ))
