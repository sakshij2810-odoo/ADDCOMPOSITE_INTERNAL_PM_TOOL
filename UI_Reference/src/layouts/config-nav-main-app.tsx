    ...
    items: [
      {
        ...
        icon: ICONS.course,
        modules: [MODULE_KEYS.QUESTIONS, MODULE_KEYS.QUESTIONS_OPTIONS, MODULE_KEYS.ANSWERS, MODULE_KEYS.SERVICE],
        // children: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ICONS.course,
        modules: [MODULE_KEYS.SETTING_CUSTOMER_AUTOMATION, MODULE_KEYS.SETTING_TEMPLATE, MODULE_KEYS.SETTING_AUTOMATION],
        children: [
          {
