...
export const AppConfigurationProvider: React.FC<{ children: React.ReactNode }> = (props) => {
  ...
  const fetchAppConfig = async () => {
    ...
    console.log('🔍 [CONFIG] Cleared localStorage cache');
    ...
    try {
      ...
      console.log('🔍 [CONFIG] Company Data:', companyData);
      console.log('🔍 [CONFIG] Preview Logo:', companyData.preview_logo);
      console.log('🔍 [CONFIG] Preview Favicon:', companyData.preview_fav_icon);
      ...
      console.log('🔍 [CONFIG] Config Data:', configData);
