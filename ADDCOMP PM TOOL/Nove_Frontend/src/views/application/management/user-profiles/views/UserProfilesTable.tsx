...
import { clearUserProfileFullStateSync, fetchMultipleUsersWithArgsAsync } from 'src/redux/child-reducers';
...
const UserProfilesTable = () => {
    ...
    const {
        ...
        count: totalCount,
        loading: dataLoading
    } = useAppSelector((storeState: IStoreState) => storeState.management.userProfiles.user_profile_list);
    ...
    const tasksTableProps: IDataTableV2Props = {
        ...
        masterColumns: [
            ...
            },
            {
                ...
                onRowCellRender: (value, row: IUserProfile) => {
                    // 
                    return <Typography variant='body1'>{`${row.first_name} ${row.last_name ? row.last_name : ""}`}</Typography>
                },
    ...
    return (
        <DashboardContent metaTitle='Users'>
            ...
            {openCreateUserDialog && <CreateNewUserDialog
