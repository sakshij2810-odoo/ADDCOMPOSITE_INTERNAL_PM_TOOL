...
import { CustomerBasicDetailsForm, CustomerServicesTableView, DocumentsChecklist, InvoicesAndPayments, CustomerRetainerAgreementsTable } from './tabs-view';
...
const TABS: ITab[] = [
    { value: 'RETAINER_DUCUMENTS', label: 'Retainer Documents', module: MODULE_KEYS.CUSTOMER_RETAINER, icon: <Iconify icon="solar:user-id-bold" width={24} /> },
    { value: 'INVOICES_AND_PAYMENTS', label: 'Invoices & Payments', module: MODULE_KEYS.CUSTOMER_INVOICE_AND_PAYMENT, icon: <Iconify icon="solar:user-id-bold" width={24} /> },
    { value: 'BASIC_DETAILS', label: 'Personal Information Form', module: MODULE_KEYS.CUSTOMER_PERSONAL_INFORMATION, icon: <Iconify icon="solar:user-id-bold" width={24} /> },
    { value: 'SERVICES', label: 'Services', module: MODULE_KEYS.CUSTOMER_SERVICES, icon: <Iconify icon="solar:user-id-bold" width={24} /> },
    ...
    return (
        <DashboardContent>
            ...
            <CustomerInfoProvider>
                ...
                {tabs.value === 'INVOICES_AND_PAYMENTS' && (
                    <InvoiceAndPaymentsTable />
                )}
                {tabs.value === 'BASIC_DETAILS' && (
                    <CustomerBasicDetailsForm />
                )}
                {tabs.value === 'DOCUMENTS_CHECKLIST' && (
                    <DocumentsChecklist />
                )}
            </CustomerInfoProvider>
        </DashboardContent>
