...
export const ProjectFormRightPanel: React.FC<ITaskActivityFormRightPanelProps> = (props) => {
  //################################ Props ################################//
  const { open, onClose, data = defaultTaskActivity, changeTab, onSaveSuccess } = props;
      ...
      <MuiRightPanel
        ...
        actionButtons={
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              <Button variant="outlined" disabled={isSubmitting} fullWidth onClick={onClose}>
                Cancel
              </Button>
            </Grid>
          </Grid>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          <Grid item xs={12} md={6}>
            <MuiFormFields.MuiDatePicker
              ...
              onChange={(newValue) => setFieldValue('date_created', newValue)}
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <MuiFormFields.MuiDatePicker
          ...
          <Grid item xs={12} md={6}>
            <MuiFormFields.MuiDatePicker
              ...
              value={values.task_completed_date as any}
              onChange={(newValue) => setFieldValue('task_completed_date', newValue)}
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <MuiFormFields.MuiTimePicker
              ...
              formattedOutput
              value={values.time_completed as any}
              onChange={(newValue) => setFieldValue('time_completed', newValue)}
            />
          </Grid>
          <Grid item xs={12} md={6}>
