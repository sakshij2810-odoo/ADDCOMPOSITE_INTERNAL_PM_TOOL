...
import nova_app_logo from "src/assets/png/nova_app_logo.png"
import { NovaAppSvgLogo } from 'src/assets/svg/nova-app-svg-logo';
// ----------------------------------------------------------------------
...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    const { logo, favIcon } = useAppConfiguration();
    ...
    */
    ...
    return (
      ...
      >
        ...
        {/* <NovaAppSvgLogo /> */}
        <img src={isSingle ? favIcon : logo} height="100%" width="100%" />
      </Box>
    );
  }
);
