...
import ReferralNavItem from 'src/components/ReferralNavItem';
...
export const _account = [
  ...
  },
  {
    label: 'Referral',
    href: '#',
    icon: <SvgIcon xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
